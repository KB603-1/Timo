...
<template>
  <button
    ...
    class="flex items-center gap-1.5 px-3 py-1.5 bg-white border border-gray-200 rounded-full shadow-sm text-sm font-bold text-gray-700 hover:bg-gray-50 transition active:scale-95"
  >
  ...
  <Teleport to="body">
    <Transition name="sheet">
      <div v-if="isModalOpen" class="fixed inset-0 z-[100] flex items-end">
        <!-- 딤 배경 -->
        <div
        ...
        <!-- 시트 -->
        <div
          class="sheet-content relative w-full bg-white rounded-t-3xl px-5 pt-4 pb-10 max-h-[70vh] flex flex-col shadow-2xl"
        >
          <!-- 핸들 -->
